...
const ShopPage = () => {
  ...
  const glassesItems = Array.from({ length: 9 }).map((_, i) => ({
    id: i + 1,
  ...
  const shapes = ['Aviator', 'Round', 'Wayfarer', 'Cat Eye', 'Geometric', 'Square'];
  const faceShapes = ['Oval', 'Heart', 'Square', 'Round', 'Triangle', 'Diamond'];
  ...
  return (
    <div className="shop-page">
      ...
      <section className="welcome-section animate-fade-in">
        <h1>Welcome to the <span className="premium-gradient-text">Future of Vision</span></h1>
        <p>Curated eyewear for the digital explorer. Perfect fit, guaranteed by AR.</p>
      </section>
        ...
        <div className="product-matrix-container">
          ...
          <footer className="matrix-footer">
            ...
            <div className="page-limit">
              ...
              <select className="limit-select" value={itemsPerPage} onChange={(e) => setItemsPerPage(e.target.value)}>
